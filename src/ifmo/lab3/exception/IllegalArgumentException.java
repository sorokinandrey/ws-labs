...
public class IllegalArgumentException extends Exception {
    ...
    public IllegalArgumentException(String message, CountriesServiceFault fault) {
        super(message);
        this.fault = fault;
    }

    public IllegalArgumentException(String message, CountriesServiceFault fault, Throwable cause) {
        super(message, cause);
        this.fault = fault;
    }
